...
static const uint16_t AppxD_I[1287] = { /* Appendix D Table 1 - 5 of 13 characters */
...
static const uint16_t AppxD_II[78] = { /* Appendix D Table II - 2 of 13 characters */
...
static void breakup(int16_t fcs_bit[], uint16_t usps_crc)
{
	int i;
